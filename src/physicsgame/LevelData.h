...
public:
	...
	static char LoadLevel(PhysicsGame* a_game, int a_level, unsigned int& a_goalObject, unsigned int& a_targetShape);

private:

	static char Level0(PhysicsGame* a_game, unsigned int& a_goalObject, unsigned int& a_targetShape);
